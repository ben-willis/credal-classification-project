...
The naive Bayes classifier have been shown to be highly effective in many different situation and comparable in performance to more complex classifiers \cite{Ashari13}.
