...
Alternatively we can rewrite our original definition of credal dominance \cref{Credal Dominance} as:
\begin{equation}
...
The NCC has greater determinacy for all values of $s$ however it still does not return a single class output for any vehicle when $s=5$.
